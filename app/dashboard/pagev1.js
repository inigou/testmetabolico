...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const ultimo = mensajesChat[mensajesChat.length - 1];
    // Solo hace scroll cuando llega una respuesta nueva, no mientras el usuario escribe
    if (!ultimo?.cargando || mensajesChat.length === 1) {
